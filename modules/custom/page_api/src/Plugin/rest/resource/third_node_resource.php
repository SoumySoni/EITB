 ...
 * @RestResource(
 *   id = "third",
 *   label = @Translation("Third api Resource"),
 *   uri_paths = {
 *     "canonical" = "/third/node"
 *   }
 * )
 */
class third_node_resource extends ResourceBase {
  ...
  public function get() {
    ...
    if ($node_id) {
     ...
     $paragraph_field_items = $node->get('field_th')->getValue();
